...
const getPostByAuthor = asyncHandler( async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, posts, "Post by this author fetched successfully"));   
} )
...
const deletePost = asyncHandler( async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "Post Deleted Successfully"));
