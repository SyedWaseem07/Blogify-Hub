...
const registerUser = asyncHandler( async(req, res, next) => {
    ...
    if(!registeredUser)  throw new ApiError(500, "Something went wrong while registering user");      
...
const loginUser = asyncHandler( async(req, res) => {
    ...
    if(password.length === 0) throw new ApiError(400, "Password required for login")
...
const getAllAuthors = asyncHandler( async(req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, authors, "Authors fetched successfully"));
} )
